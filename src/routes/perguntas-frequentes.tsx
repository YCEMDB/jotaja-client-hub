...
const TITLE = "Perguntas Frequentes — Mesivo";
const DESC = "50+ perguntas reais sobre a Mesivo: planos, pagamento, cardápio, delivery, mesas, suporte e técnico. Tudo o que você precisa antes de começar.";
...
const groups: Group[] = [
  {
    title: "Geral",
    items: [
      { q: "O que é a Mesivo?", aShort: "Plataforma brasileira de cardápio digital, comandas e gestão de restaurantes.", aLong: "A Mesivo centraliza pedidos (salão, delivery, retirada), mesas, comandas digitais, pagamento online e relatórios em um painel único, sem comissão por pedido." },
      { q: "Para quem a Mesivo serve?", aShort: "Restaurantes, pizzarias, hamburguerias, lanchonetes, açaiterias, bares e dark kitchens.", aLong: "Qualquer operação que vende comida ou bebida por delivery, retirada ou consumo no salão. Funciona tanto para 1 unidade quanto para múltiplas lojas." },
      { q: "A Mesivo é gratuita?", aShort: "Tem 14 dias grátis, depois R$ 99/mês fixo.", aLong: "Os 14 dias liberam todos os recursos do plano Pro sem precisar cadastrar cartão. Depois, planos a partir de R$ 99/mês, sem comissão por pedido." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "A Mesivo fica com parte do pagamento?", aShort: "Não. 100% do valor cai na sua conta.", aLong: "A Mesivo cobra somente a mensalidade fixa. Tarifas do Mercado Pago (PIX e cartão) são as do próprio MP, sem markup nosso." },
      { q: "Em quanto tempo o PIX cai na conta?", aShort: "Em segundos.", aLong: "O Mercado Pago credita o PIX em segundos. O painel da Mesivo mostra o pedido como pago automaticamente via webhook." },
      ...
      { q: "Tem taxa para o cliente final?", aShort: "Não pela Mesivo.", aLong: "O cliente final não paga taxa para nossa plataforma. As tarifas de cartão/PIX são do Mercado Pago e ficam por sua conta." },
      { q: "Como pago a mensalidade da Mesivo?", aShort: "Cartão de crédito ou PIX recorrente.", aLong: "Cobrança automática mensal pelo cartão cadastrado ou PIX recorrente. Você recebe boleto/NF por email." },
    ],
  },
  {
    title: "Cardápio",
    items: [
      ...
      { q: "O time pode cadastrar o cardápio por mim?", aShort: "Sim, no onboarding.", aLong: "Envie PDF/foto do cardápio atual e o time da Mesivo cadastra para você gratuitamente no plano Pro." },
    ],
  },
  {
    title: "Delivery e retirada",
    items: [
      { q: "A Mesivo fornece entregadores?", aShort: "Não.", aLong: "Você usa sua própria equipe ou contrata terceiros (motoboys, uClub, Lalamove). A plataforma só gerencia o pedido." },
  ...
  },
  {
    ...
    items: [
      ...
      { q: "A Mesivo usa meus dados de clientes?", aShort: "Não.", aLong: "Os dados de clientes pertencem ao restaurante. Não vendemos, não compartilhamos com terceiros, não usamos para campanhas próprias." },
  ...
  return (
    <ContentLayout width="wide">
      <header>
        ...
        <p className="lead">
          {allFAQs.length} respostas reais sobre a Mesivo — planos, pagamento, cardápio, delivery, mesas, suporte e técnico.
        </p>
      </header>
