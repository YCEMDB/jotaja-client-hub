        ...
        children: JSON.stringify({
          ...
          mainEntity: [
            ...
            },
            {
              ...
              acceptedAnswer: {
                "@type": "Answer",
                text: "Plataformas variam de gratuitas (com limitações) até R$ 200/mês. O ComandaHub oferece cardápio digital sem comissão por venda a partir de planos acessíveis.",
              },
            },
            {
              "@type": "Question",
...
function CardapioDigitalPage() {
  return (
    <ContentLayout>
      ...
      <p>
        O ComandaHub é a plataforma de delivery próprio que une cardápio digital,
      ...
      <p>
        Sim, no ComandaHub o cardápio fica em <code>sua-loja.comandahub.online</code>{" "}
