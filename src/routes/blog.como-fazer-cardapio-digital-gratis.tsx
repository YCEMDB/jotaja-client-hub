...
const DESC =
  "Quer cardápio digital gratuito? Veja as melhores opções, limitações e como começar grátis no Mesivo sem perder funcionalidade essencial.";
...
function GratisPage() {
  return (
    <ContentLayout>
      ...
      <ol>
        <li>
          Crie conta no <Link to="/auth">Mesivo</Link> — você ganha período
      ...
      <p className="lead">
        <Link to="/auth">Comece grátis no Mesivo</Link> sem cartão de
        crédito.
      </p>
    </ContentLayout>
  );
