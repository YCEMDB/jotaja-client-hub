...
const TITLE = "Política de Privacidade — Mesivo";
const DESC =
  "Política de privacidade do Mesivo: quais dados coletamos, como usamos, com quem compartilhamos e como você exerce seus direitos pela LGPD.";
...
function Privacidade() {
  return (
    <ContentLayout>
      ...
      <p className="lead">
        Esta política descreve como o Mesivo coleta, usa, armazena e
