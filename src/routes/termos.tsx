...
const TITLE = "Termos de Uso — Mesivo";
const DESC =
  "Termos de uso da plataforma Mesivo: regras de utilização, responsabilidades, pagamentos, cancelamento e propriedade intelectual.";
...
function Termos() {
  return (
    <ContentLayout>
      ...
      <p className="lead">
        Estes Termos regulam o uso da plataforma Mesivo. Ao criar uma
      ...
      <p>
        ...
        permanecem de sua propriedade. O Mesivo apenas hospeda e exibe
      ...
      <p>
        O Mesivo é uma ferramenta tecnológica. As decisões comerciais,
