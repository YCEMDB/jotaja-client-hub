...
export const Route = createFileRoute("/dev/proto/landing")({
  ...
  head: () => ({ meta: [{ title: "Proto · Landing Mesivo (dev)" }, { name: "robots", content: "noindex" }] }),
});
      ...
      <header className="mkt-header">
        <div className="mkt-container flex items-center justify-between py-5">
          ...
          <nav className="mkt-nav">
            <a>Produto</a><a>Segmentos</a><a>Preços</a><a>Blog</a><a>Contato</a>
          </nav>
      ...
      <section className="mkt-hero">
        <div className="mkt-container mkt-hero-grid">
          <div>
            ...
            <h1 className="mkt-h1">
              O sistema que <em>conecta</em> salão,<br />cozinha e entrega
              <span className="mkt-accent">.</span>
            </h1>
            <p className="mkt-sub">
              Mesivo unifica pedidos, PDV, KDS e cardápio digital em uma plataforma calorosa,
              leve e feita pra restaurante de verdade. Do balcão à moto.
            </p>
          ...
          <div className="mkt-marquee-track">
            {Array.from({ length: 2 }).map((_, k) => (
              <div key={k} className="flex gap-10 pr-10">
                {["Salão", "Cozinha", "Balcão", "Delivery", "Retirada", "Mesas", "Comandas", "Estoque", "Fiscal", "Motoboy"].map((w) => (
      ...
      <section className="mkt-section mkt-section-cream">
        <div className="mkt-container">
          ...
          <p className="mkt-sub mkt-center mkt-max-2xl">
            Mesivo foi desenhada pensando no fluxo real do restaurante brasileiro — do balcão ao motoboy.
          </p>

          <div className="mkt-feature-bento">
            <div className="mkt-feature-card mkt-feature-lg">
              <div className="mkt-feature-tag">PDV</div>
              <h3 className="mkt-feature-title">Balcão veloz, atalhos de teclado, split de pagamento</h3>
              <div className="mkt-pdv-preview"><PdvMiniMockup /></div>
            </div>
            <div className="mkt-feature-card mkt-feature-coral">
              ...
              <p className="mkt-feature-body-inv">Cardápio próprio do restaurante, Mesivo por trás.</p>
            </div>
            <div className="mkt-feature-card">
              ...
              <p className="mkt-feature-body">Modo tela cheia com fila por prioridade e SLA visual.</p>
            </div>
            <div className="mkt-feature-card">
            ...
            <div className="mkt-feature-card mkt-feature-wide">
              ...
              <h3 className="mkt-feature-title">Conciliação de PagBank e Mercado Pago em tempo real</h3>
              <p className="mkt-feature-body">Fechamento com trilha auditável, evento por evento.</p>
              <div className="mkt-caixa-mini"><CaixaMini /></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="mkt-footer">
        <div className="mkt-container flex items-center justify-between py-8">
          ...
          <div className="mkt-footer-links">
            <a>Termos</a><a>Privacidade</a><a>Segurança</a><a>Status</a>
          </div>
        </div>
      </footer>
    </div>
...
function MesivoMark({ small = false }: { small?: boolean }) {
  ...
  return (
    <svg width={s} height={s} viewBox="0 0 32 32" fill="none">
      ...
      <path d="M8 22V10l4 6 4-6v12M20 10v12M20 10c3 0 5 2 5 5s-2 5-5 5" stroke="#FFF8EE" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
...
function FlowLines() {
  return (
    <svg className="mkt-flowlines" viewBox="0 0 600 500" fill="none" aria-hidden>
      <path d="M20 60 C 180 60 220 220 380 220" stroke="#F0522D" strokeWidth="1.5" strokeDasharray="4 6" opacity="0.5" />
      <path d="M40 460 C 200 460 260 300 420 300" stroke="#FFB82E" strokeWidth="1.5" strokeDasharray="4 6" opacity="0.6" />
      ...
      <div className="dm-body">
        ...
        <main className="dm-main">
          <div className="dm-header">
            ...
            <div className="dm-tabs"><span className="on">Todos</span><span>Salão</span><span>Delivery</span></div>
          </div>
    ...
    <div className="pm">
      ...
      <div className="pm-brand">
        ...
        <div>
          ...
          <div className="pm-open"><span /> Aberto agora · 25–35 min</div>
        </div>
      </div>
      ...
      <div className="pm-items">
        {[["Smash duplo", "R$ 34,90"], ["Cheddar bacon", "R$ 38,50"], ["Veggie", "R$ 29,00"]].map(([n, p]) => (
          <div key={n} className="pm-item">
            <div className="pm-thumb" />
            <div className="pm-info"><div className="pm-title">{n}</div><div className="pm-desc">Pão brioche · molho da casa</div></div>
...
function FlowDiagram() {
  const nodes = [
    ["Salão", "#F0522D"], ["Cozinha", "#FFB82E"], ["Balcão", "#2F7D5B"],
    ["Delivery", "#34241D"], ["Motoboy", "#F0522D"], ["Cliente", "#FFB82E"],
  ];
  return (
    <svg viewBox="0 0 520 260" width="100%">
      ...
      {[
        [90, 60, 260, 60], [260, 60, 430, 60],
        [90, 200, 260, 200], [260, 200, 430, 200],
        [90, 60, 90, 200], [430, 60, 430, 200],
      ].map(([x1, y1, x2, y2], i) => (
        <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke="#34241D" strokeWidth="1.2" strokeDasharray="3 5" markerEnd="url(#arr)" opacity="0.5" />
      ))}
      {nodes.map(([label, c], i) => {
        const positions = [[90, 60], [260, 60], [430, 60], [90, 200], [260, 200], [430, 200]];
        const [cx, cy] = positions[i];
        return (
          <g key={label}>
            <circle cx={cx} cy={cy} r="34" fill="#FFFDFA" stroke={c as string} strokeWidth="2.2" />
            <text x={cx} y={cy + 4} textAnchor="middle" fontSize="12" fill="#34241D" fontWeight="600">{label}</text>
          </g>
        );
      })}
      <circle cx="260" cy="130" r="46" fill="#F0522D" />
      <text x="260" y="128" textAnchor="middle" fill="#FFF8EE" fontSize="13" fontWeight="700">Mesivo</text>
      <text x="260" y="144" textAnchor="middle" fill="#FFE7D5" fontSize="10">core</text>
    </svg>
  );
}
...
function PdvMiniMockup() {
  return (
    <div className="pdvm">
      <div className="pdvm-cats">{["Hambúrgueres", "Bebidas", "Sobremesas"].map((c, i) => <span key={c} className={i === 0 ? "on" : ""}>{c}</span>)}</div>
      <div className="pdvm-grid">
        {["Smash", "Cheddar", "Veggie", "Bacon", "Duplo", "Kids"].map(n => (
          <div key={n} className="pdvm-prod"><div className="pdvm-thumb" /><div className="pdvm-name">{n}</div><div className="pdvm-price">R$ 29,90</div></div>
        ))}
      </div>
      <div className="pdvm-cart">
        <div className="pdvm-cart-row"><span>1× Smash</span><span>R$ 29,90</span></div>
        <div className="pdvm-cart-row"><span>1× Coca lata</span><span>R$ 7,00</span></div>
        <div className="pdvm-cart-total"><span>Total</span><strong>R$ 36,90</strong></div>
...
function CaixaMini() {
  return (
    <div className="cxm">
      <div className="cxm-row"><span>PagBank Pix</span><strong>R$ 1.284,00</strong><span className="cxm-ok">conciliado</span></div>
      <div className="cxm-row"><span>Mercado Pago</span><strong>R$ 986,50</strong><span className="cxm-ok">conciliado</span></div>
      <div className="cxm-row"><span>Dinheiro</span><strong>R$ 342,00</strong><span className="cxm-warn">contar</span></div>
    </div>
  );
}
