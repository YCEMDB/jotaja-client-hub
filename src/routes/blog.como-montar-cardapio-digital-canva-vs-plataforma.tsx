...
function CanvaPage() {
  return (
    <ContentLayout>
      ...
      <h2>Quando usar plataforma (ComandaHub)</h2>
      <p>
      ...
      <ol>
        ...
        <li>
          Use ComandaHub para o <strong>cardápio funcional</strong> que recebe
          pedido.
        </li>
        <li>
          Cole o QR Code do ComandaHub na arte do Canva. Pronto: design Canva +
          inteligência ComandaHub.
        </li>
      </ol>
