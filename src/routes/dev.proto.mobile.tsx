...
export const Route = createFileRoute("/dev/proto/mobile")({
  ...
  head: () => ({ meta: [{ title: "Proto · Mobile Mesivo (dev)" }, { name: "robots", content: "noindex" }] }),
});
      ...
      <div className="mob-landing">
        <div className="mob-landing-hdr">
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <svg width="24" height="24" viewBox="0 0 32 32"><rect x="1" y="1" width="30" height="30" rx="9" fill="#F0522D"/><path d="M8 22V10l4 6 4-6v12M20 10v12M20 10c3 0 5 2 5 5s-2 5-5 5" stroke="#FFF8EE" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"/></svg>
            <span style={{ fontFamily: "'Archivo Black'", fontSize: 15 }}>Mesivo</span>
          </div>
          <span style={{ fontSize: 22 }}>≡</span>
        </div>
        <div className="mob-landing-hero">
          <span className="mkt-eyebrow" style={{ fontSize: 11 }}><span className="mkt-dot" /> Food-tech brasileira</span>
        ...
        <div className="mob-landing-mock">
          <div className="dm">
            <div className="dm-top"><div className="dm-dots"><i/><i/><i/></div><div className="dm-url">admin.mesivo.app</div></div>
            <div className="dm-body">
              <aside className="dm-side">
                <div className="dm-logo">M</div>
                {["Início", "Pedidos", "PDV", "Mesas"].map((x, i) => (
                  <div key={x} className={"dm-item " + (i === 1 ? "on" : "")}>{x}</div>
                ))}
              </aside>
              <main className="dm-main" style={{ padding: 10 }}>
                <div className="dm-title" style={{ fontSize: 14 }}>Pedidos ao vivo</div>
                <div className="dm-kpis" style={{ marginTop: 8 }}>
                  <div className="dm-kpi"><div className="dm-kpi-l">Faturamento</div><div className="dm-kpi-v" style={{ fontSize: 13 }}>R$ 4.820</div></div>
                  <div className="dm-kpi"><div className="dm-kpi-l">Pedidos</div><div className="dm-kpi-v" style={{ fontSize: 13 }}>78</div></div>
                </div>
              </main>
            </div>
          </div>
        ...
        <div style={{ padding: "0 18px 20px" }}>
          <div style={{ fontFamily: "'Archivo Black'", fontSize: 20, color: "var(--coffee)", marginTop: 10 }}>Feito para operação real.</div>
  ...
  return (
    <div data-theme="app-proto" style={{ display: "flex", flexDirection: "column", flex: 1 }}>
      ...
      <div className="mob-dash">
        ...
        <div className="mob-dash-kpis">
          <div className="app-kpi">
            ...
            <div className="app-kpi-v" style={{ fontSize: 20 }}>R$ 4.820</div>
            <div className="app-kpi-d d-leaf">+18%</div>
          </div>
          <div className="app-kpi">
            <div className="app-kpi-l">Pedidos</div>
            <div className="app-kpi-v" style={{ fontSize: 20 }}>78</div>
            <div className="app-kpi-d d-coral">+12 abertos</div>
          </div>
          <div className="app-kpi">
            <div className="app-kpi-l">Ticket médio</div>
            <div className="app-kpi-v" style={{ fontSize: 18 }}>R$ 62,10</div>
            <div className="app-kpi-d d-mango">+4%</div>
          </div>
          <div className="app-kpi">
            <div className="app-kpi-l">Tempo</div>
            <div className="app-kpi-v" style={{ fontSize: 18 }}>21 min</div>
            <div className="app-kpi-d d-leaf">-3 min</div>
          </div>
        </div>

        <div className="mob-dash-tabs">
          <span className="on">Todos</span><span>Salão</span><span>Delivery</span>
        </div>

        <div style={{ background: "#fff", margin: "10px 16px 0", border: "1px solid #E1E2DD", borderRadius: 12, overflow: "hidden" }}>
          {[
      ...
      <div className="mob-tabbar">
        <div className="mob-tab on"><span className="mob-tab-ico" />Início</div>
        <div className="mob-tab"><span className="mob-tab-ico" />Pedidos</div>
        <div className="mob-tab"><span className="mob-tab-ico" />PDV</div>
        <div className="mob-tab"><span className="mob-tab-ico" />Mesas</div>
        <div className="mob-tab"><span className="mob-tab-ico" />Mais</div>
      </div>
    </div>
  );
}
...
function MobPdv() {
  return (
    <div data-theme="app-proto" style={{ display: "flex", flexDirection: "column", flex: 1, position: "relative" }}>
      <div className="mob-notch" style={{ background: "#20211F" }} />
      <div className="mob-pdv">
        ...
        <div className="mob-pdv-cats">
          <span className="on">Burgers</span><span>Combos</span><span>Bebidas</span><span>Sobremesas</span>
        </div>
        <div className="mob-pdv-grid">
          {[["Smash duplo", "34,90"], ["Cheddar bacon", "38,50"], ["Veggie", "29,00"], ["Chorizo", "45,00"], ["Fish", "35,00"], ["Kids", "22,00"]].map(([n, p]) => (
...
function MobCardapio() {
  return (
    <div data-theme="tx-proto" style={{ display: "flex", flexDirection: "column", flex: 1, position: "relative" }}>
      ...
      <div className="tx-root mob-cardapio">
        ...
        <div className="tx-brand-block">
          <div className="tx-brand-card">
            ...
            <div className="tx-brand-h">
              ...
              <div className="tx-open"><span className="tx-open-dot" /> Aberto · 25–35 min</div>
            </div>
          </div>
        </div>
        ...
        <div className="tx-list">
          ...
          {[["Smash duplo", "34,90"], ["Cheddar bacon", "38,50"], ["Veggie", "29,00"]].map(([n, p]) => (
    ...
    <div data-theme="tx-proto" style={{ display: "flex", flexDirection: "column", flex: 1 }}>
      ...
      <div className="mob-pedido">
        <div className="mob-pedido-hdr">
          <div style={{ fontSize: 11, color: "#666", textTransform: "uppercase", letterSpacing: ".08em" }}>Pedido #0822</div>
        ...
        <div className="mob-pedido-steps">
          <div className="mob-pedido-step done">
            ...
            <div><div className="mob-pedido-step-t">Recebido</div><div className="mob-pedido-step-h">19:04 · pagamento aprovado</div></div>
          </div>
          <div className="mob-pedido-step done">
            <div className="mob-pedido-step-i">✓</div>
            <div><div className="mob-pedido-step-t">Preparando</div><div className="mob-pedido-step-h">19:08 · na cozinha</div></div>
          </div>
          <div className="mob-pedido-step active">
            <div className="mob-pedido-step-i">•</div>
            <div><div className="mob-pedido-step-t">Saiu para entrega</div><div className="mob-pedido-step-h">19:22 · com Bruno</div></div>
          </div>
          <div className="mob-pedido-step">
            <div className="mob-pedido-step-i">4</div>
            <div><div className="mob-pedido-step-t">Entregue</div><div className="mob-pedido-step-h">previsto 19:34</div></div>
          </div>
        </div>
        <div className="mob-pedido-tot">
          <div>
            <div style={{ fontSize: 11, color: "#CCC", textTransform: "uppercase" }}>Total pago</div>
            <div className="mob-pedido-tot-t">R$ 96,50</div>
          </div>
          <div style={{ background: "#F4C752", color: "#23303A", padding: "8px 14px", borderRadius: 8, fontSize: 12, fontWeight: 800 }}>Pix</div>
        </div>
        <div className="tx-powered" style={{ marginTop: 20 }}>Tecnologia <strong>Mesivo</strong></div>
      </div>
    </div>
  );
}
    ...
    <div style={{ display: "flex", flexDirection: "column", flex: 1, background: "#111" }}>
      ...
      <div className="mob-moto">
        <div className="mob-moto-hdr">
          ...
          <div className="mob-moto-online"><span /> Online</div>
        </div>
        ...
        <div className="mob-moto-card">
          ...
          <div className="mob-moto-card-a">Rua das Flores, 240 · Ap 12<br />Vila Madalena · 2,4 km</div>
        ...
        <div style={{ padding: "0 16px", fontSize: 13, color: "#999", marginBottom: 8 }}>Próxima parada</div>
        <div className="mob-moto-card" style={{ marginTop: 0 }}>
          <div style={{ fontSize: 14, color: "#CCC" }}>Retirada em</div>
          <div style={{ fontFamily: "'Archivo Black'", fontSize: 18, marginTop: 4 }}>Burger da Praça</div>
