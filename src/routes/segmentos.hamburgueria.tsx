...
const DESC =
  "Mesivo para hamburgueria: combos, ponto da carne, adicionais ilimitados, PIX, delivery próprio e cardápio com fotos que vendem. Sem comissão.";
  ...
  return (
    <ContentLayout>
      ...
      <p className="lead">
        ...
        no fluxo. O Mesivo entrega isso sem cobrar comissão.
      </p>
      ...
      <p>
        Use o link do Mesivo na bio do Instagram e no WhatsApp Business.{" "}
