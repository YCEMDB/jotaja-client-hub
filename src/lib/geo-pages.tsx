...
export const COMMON_FAQS: GeoFAQ[] = [
  { q: "A ComandaHub cobra comissão por pedido?", a: "Não. Você paga apenas a mensalidade fixa. 100% do valor dos pedidos cai direto na sua conta." },
...
export const GEO_PAGES: Record<string, Omit<GeoPageProps, "schemaType">> = {
  "sistema-para-restaurantes": {
    ...
    title: "Sistema para Restaurantes — Comandas, Mesas e Delivery | ComandaHub",
    ...
    quickAnswer:
      "A ComandaHub é um sistema para restaurantes que reúne cardápio digital, comandas, controle de mesas via QR Code, pedidos delivery e pagamento online (PIX e cartão Mercado Pago) em um único painel em tempo real. Cobra mensalidade fixa a partir de R$ 99, sem comissão por pedido, e mantém o cliente como do restaurante. Funciona em qualquer celular, tablet ou computador, com 14 dias grátis sem cartão.",
    sections: [
  ...
  "sistema-para-pizzarias": {
    ...
    title: "Sistema para Pizzaria — Sabores, Bordas e Meio a Meio | ComandaHub",
    ...
    quickAnswer:
      "A ComandaHub é o sistema para pizzaria com suporte nativo a pizza meio a meio, bordas recheadas, combos família, bebidas e adicionais. Recebe pedidos por delivery, retirada e mesa (QR Code), aceita PIX e cartão pelo Mercado Pago, cobra taxa por bairro e organiza a fila de produção. Mensalidade fixa a partir de R$ 99, sem comissão por pedido.",
    sections: [
  ...
  "sistema-para-lanchonetes": {
    ...
    title: "Sistema para Lanchonete — Pedidos Rápidos e PIX | ComandaHub",
  ...
  "sistema-para-acaiterias": {
    ...
    title: "Sistema para Açaiteria — Tamanhos, Acompanhamentos e PIX | ComandaHub",
    ...
    quickAnswer:
      "A ComandaHub é o sistema para açaiteria com cadastro de tamanhos (300ml, 500ml, 700ml, 1L), acompanhamentos pagos e gratuitos, combos família, delivery por bairro e pagamento PIX. Painel mostra cada pedido em tempo real para o operador montar o copo correto sem erro. Mensalidade fixa a partir de R$ 99/mês.",
    sections: [
  ...
  "sistema-para-bares": {
    ...
    title: "Sistema para Bar — Comanda Digital e Mesas | ComandaHub",
  ...
  "sistema-para-hamburguerias": {
    ...
    title: "Sistema para Hamburgueria — Combos, Ponto e Adicionais | ComandaHub",
    ...
    quickAnswer:
      "A ComandaHub é o sistema para hamburgueria com combos (burger + batata + bebida), ponto da carne obrigatório, adicionais ilimitados (bacon, cheddar, molhos), upsell automático, delivery por bairro e PIX integrado. Aumenta ticket médio em 20-30% só com sugestão no fluxo. Mensalidade fixa a partir de R$ 99/mês.",
    sections: [
  ...
  "sistema-para-delivery": {
    ...
    title: "Sistema para Delivery — Sem Comissão, Cliente Seu | ComandaHub",
    ...
    quickAnswer:
      "A ComandaHub é um sistema de delivery próprio para restaurantes, sem comissão por pedido. Você recebe pelo seu link (comandahub.online/sua-loja), cobra taxa por bairro/CEP/raio, aceita PIX e cartão online, e o cliente fica na sua base — não na do iFood. Mensalidade fixa a partir de R$ 99/mês, com 14 dias grátis.",
    sections: [
    ...
    faqs: baseFAQs([
      { q: "A ComandaHub fornece entregadores?", a: "Não. Você usa sua equipe própria ou contrata motoboys/uClub." },
  ...
  "sistema-de-comandas-digitais": {
    ...
    title: "Sistema de Comandas Digitais para Restaurantes | ComandaHub",
    ...
    quickAnswer:
      "Um sistema de comandas digitais substitui o papel ou caderno por uma comanda eletrônica acessível por QR Code na mesa, pelo garçom ou pelo caixa. A ComandaHub registra cada pedido com horário, mesa e responsável, evita perda de comanda, permite fechamento parcial e divisão de conta, e aceita PIX/cartão no fechamento. Mensalidade fixa a partir de R$ 99/mês.",
    sections: [
    ...
    related: [
      { label: "Controle de mesas", to: "/controle-de-mesas" },
      { label: "ComandaHub vs comanda de papel", to: "/comparativo/comandahub-vs-comanda-de-papel" as const },
    ],
  },

  "controle-de-mesas": {
    path: "/controle-de-mesas",
    title: "Controle de Mesas com QR Code para Restaurantes | ComandaHub",
  ...
  "gestao-de-restaurantes": {
    ...
    title: "Gestão de Restaurantes — Sistema Completo | ComandaHub",
    ...
    quickAnswer:
      "Software de gestão de restaurantes que centraliza pedidos (salão, delivery, retirada), controle de mesas, financeiro diário, relatórios de vendas, cardápio digital e marketing (cupons) em um painel único. A ComandaHub elimina a dependência de planilhas Excel e cadernos, integrando todas as operações em tempo real. Mensalidade fixa a partir de R$ 99/mês, sem comissão por pedido.",
    sections: [
...
export const COMPARISON_PAGES: Record<string, Omit<GeoPageProps, "schemaType">> = {
  "planilha": {
    ...
    title: "ComandaHub vs Planilha Excel para Restaurante | ComandaHub",
    description: "Comparativo: ComandaHub vs planilha Excel para gestão de restaurante. Veja vantagens, limites e por que migrar de planilha para sistema digital.",
    h1: "ComandaHub vs planilha Excel",
    quickAnswer:
      "Planilha Excel funciona para um restaurante muito pequeno, mas falha em pedidos simultâneos, controle em tempo real e integração com pagamento. A ComandaHub substitui a planilha com painel ao vivo, pedidos centralizados, PIX integrado e relatórios automáticos — pelo preço de R$ 99/mês fixo, sem comissão por pedido.",
    sections: [
      ...
      { heading: "Onde a ComandaHub ganha", body: list([
    ...
    faqs: baseFAQs([
      { q: "Eu importo minha planilha?", a: "Você pode enviar a planilha e o time da ComandaHub cadastra o cardápio para você no onboarding." },
    ]),
  ...
  "caderno": {
    ...
    title: "ComandaHub vs Caderno de Pedidos | ComandaHub",
    description: "Comparativo: ComandaHub vs caderno de anotação. Veja por que caderno gera erros, perdas e por que migrar para sistema de comandas digitais.",
    h1: "ComandaHub vs caderno de pedidos",
    quickAnswer:
      "Anotar pedido em caderno é fonte garantida de erro, perda e retrabalho: letra ilegível, página rasgada, fechamento manual demorado. A ComandaHub substitui o caderno com comanda digital por mesa e por garçom, lançamento em segundos pelo celular e fechamento de caixa automático ao final do dia. R$ 99/mês fixo.",
    sections: [
      ...
      { heading: "Como a ComandaHub resolve", body: list([
  ...
  "comanda-de-papel": {
    ...
    title: "ComandaHub vs Comanda de Papel | ComandaHub",
    description: "Comparativo: ComandaHub vs comanda de papel. Veja por que comanda digital evita perdas, agiliza atendimento e reduz erros de fechamento.",
    h1: "ComandaHub vs comanda de papel",
    quickAnswer:
      "Comanda de papel some, molha, rasga e exige soma manual na hora de fechar. A comanda digital da ComandaHub é uma comanda eletrônica por mesa, atualizada em tempo real, com divisão automática de conta, fechamento por PIX e relatório por garçom e turno. R$ 99/mês fixo, sem comissão.",
    sections: [
  ...
  "controle-manual": {
    ...
    title: "ComandaHub vs Controle Manual de Restaurante | ComandaHub",
    description: "Comparativo: ComandaHub vs controle manual (papel, caderno, planilha). Veja quanto tempo e dinheiro você perde com controle analógico.",
    h1: "ComandaHub vs controle manual",
    quickAnswer:
      "Controle manual (caderno + planilha + comanda de papel + WhatsApp solto) custa horas por dia e gera erro silencioso de caixa. A ComandaHub unifica pedidos, mesas, delivery e pagamento em um painel, com fechamento automático e relatório de vendas. Mensalidade fixa de R$ 99/mês, 14 dias grátis.",
    sections: [
      { heading: "Quanto tempo o controle manual consome", body: paragraphs([
        ...
        "Com a ComandaHub esse trabalho cai para minutos: fechamento de caixa é automático, PIX bate sozinho e relatório sai pronto.",
      ]) },
    ],
    faqs: baseFAQs([
