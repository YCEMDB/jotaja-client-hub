        ...
        <div className="grid grid-cols-12 gap-6 lg:gap-10 items-start">
          ...
          <div className="col-span-12 lg:col-span-7 animate-fade-up">
            ...
            <p className="mt-10 max-w-xl text-lg md:text-xl text-ink/80 leading-relaxed font-medium">
              ComandaHub é o sistema completo de delivery próprio:{" "}
          ...
          <div className="col-span-12 lg:col-span-5 relative min-h-[520px] lg:min-h-[680px] animate-fade-up" style={{ animationDelay: "0.15s" }}>
            ...
            >
              ...
              <img
                src={heroKanban}
                alt="Painel de gestão de pedidos do ComandaHub — kanban com colunas Novos, Em Preparo e Prontos"
            ...
            >
              <img
                src={heroMobile}
                alt="Cardápio digital do ComandaHub no celular — loja Bella Pizza com produtos e carrinho"
                className="block w-full h-auto"
                width={1024}
                height={1536}
              />
