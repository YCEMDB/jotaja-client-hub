      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16 md:gap-24 items-center">
          ...
          <div className="relative z-10 lg:sticky lg:top-32">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-sunset/10 border border-[#FF6B35]/30 rounded text-[#FF6B35] font-bold text-[10px] uppercase tracking-widest mb-8">
            ...
            <h2 className="font-display text-5xl md:text-7xl text-ink leading-[0.85] tracking-tighter mb-8 uppercase">
              ...
              <span className="text-[#FF6B35] border-b-4 border-[#FF6B35]">o aplicativo</span>
            </h2>
            ...
            <div className="p-8 bg-secondary border-4 border-ink shadow-brutal rounded-none transform -rotate-1">
              ...
              <p className="font-display text-4xl text-ink leading-none uppercase">
                Poupe <span className="text-[#FF6B35] underline">R$ 10.800</span>
              </p>
          ...
          <div className="relative">
            <div className="absolute -top-10 -right-10 w-40 h-40 bg-[#FF6B35]/20 blur-[100px] rounded-full" />
            ...
            <div className="relative border-[6px] border-ink bg-background shadow-[12px_12px_0_0_#000] rounded-none overflow-hidden">
              ...
              <div className="grid grid-cols-[1.5fr_1fr_1fr] bg-ink text-background py-6 px-4 md:px-8 border-b-[6px] border-ink">
                ...
                <div className="font-display font-black text-[10px] md:text-xs uppercase tracking-[0.2em] text-center text-[#FF6B35]">Mesivo</div>
              </div>

              {/* Rows */}
              <div className="divide-y-4 divide-ink">
                {COMPARISON_DATA.map((row, i) => (
                  <div key={i} className="grid grid-cols-[1.5fr_1fr_1fr] items-center group transition-colors hover:bg-[#FF6B35]/5">
                    ...
                    <div className="py-6 px-2 text-center bg-[#FF6B35]/[0.08]">
              ...
              <div className="bg-ink p-5 flex items-center justify-center gap-4">
                <div className="flex gap-1">
                  {[1,2,3].map(i => <div key={i} className="w-1 h-4 bg-[#FF6B35]" />)}
                </div>
                <p className="font-display font-black text-[10px] md:text-xs text-background uppercase tracking-[0.3em]">
                  Operação Profissional <span className="text-[#FF6B35]">Mesivo</span>
                </p>
                <div className="flex gap-1">
                  {[1,2,3].map(i => <div key={i} className="w-1 h-4 bg-[#FF6B35]" />)}
                </div>
